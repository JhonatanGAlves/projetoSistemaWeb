          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="user" method="POST" name="form_add">
                ...
                <fieldset class="mt-4 border p-2">
                  ...
                  <div class="form-group row mb-3">
                    ...
                    <div class="col-md-9 mb-3">
                        ...
                        <textarea class="form-control" name="produto_obs"><?php set_value('produto_obs'); ?></textarea>
                    </div>
                ...
                <a title="Voltar" href="<?php echo base_url('produtos'); ?>" class="btn btn-success btn-sm mt-3 ml-2"><i class="fas fa-arrow-left"></i>&nbsp;Voltar</a>
              </form>
            </div>
          </div>
