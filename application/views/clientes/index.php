                  ...
                  <tbody>
                    ...
                    <?php foreach ($clientes as $cliente): ?>
                      <tr>
                        ...
                        <td class="text-center pr-4"><?php echo ($cliente->cliente_ativo == 1 ? '<span class="badge badge-pill badge-info btn-sm">Sim</span>' : '<span class="badge badge-pill badge-warning btn-sm">Não</span>') ?></td>
                        <td class="text-right">
                          ...
                          <a title="Deletar" href="javascreipt(void)" data-toggle="modal" data-target="#cliente-<?php echo $cliente->cliente_id; ?>"  class="btn btn-sm btn-danger"><i class="fas fa-user-times"></i></a>
                        </td>
                      </tr>
