        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <a title="Cadastrar novo fornecedor" href="<?php echo base_url('fornecedores/add'); ?>" class="btn btn-success btn-sm float-right"><i class="fas fa-handshake"></i>&nbsp;Novo</a>
            </div>
            <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <?php foreach ($fornecedores as $fornecedor): ?>
                      <tr>
                        ...
                        <td class="text-center pr-4"><?php echo ($fornecedor->fornecedor_ativo == 1 ? '<span class="badge badge-pill badge-info btn-sm">Sim</span>' : '<span class="badge badge-pill badge-warning btn-sm">Não</span>') ?></td>
                        <td class="text-right">
                          ...
                          <a title="Deletar" href="javascreipt(void)" data-toggle="modal" data-target="#fornecedor-<?php echo $fornecedor->fornecedor_id; ?>"  class="btn btn-sm btn-danger"><i class="fas fa-user-times"></i></a>
                        </td>
                      </tr>
