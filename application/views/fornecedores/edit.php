          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <form class="user" method="POST" name="form_edit">
                ...
                <fieldset class="mt-4 border p-2">
                  ...
                  <div class="form-group row mb-3">
                    ...
                    <div class="col-md-4 mb-3">
                      ...
                      <div class="col-md-4">
                        <label>E-mail</label>
                        <input type="email" class="form-control form-control-user email" name="fornecedor_email" value="<?php echo $fornecedor->fornecedor_email; ?>">
                ...
                <a title="Voltar" href="<?php echo base_url('fornecedores'); ?>" class="btn btn-success btn-sm mt-3 ml-2"><i class="fas fa-arrow-left"></i>&nbsp;Voltar</a>
              </form>
            </div>
          </div>
