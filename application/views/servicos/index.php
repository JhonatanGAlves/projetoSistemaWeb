                  ...
                  <tbody>
                    ...
                    <?php foreach ($servicos as $servico): ?>
                      <tr>
                        ...
                        <td class="text-center pr-4"><?php echo ($servico->servico_ativo == 1 ? '<span class="badge badge-pill badge-info btn-sm">Sim</span>' : '<span class="badge badge-pill badge-warning btn-sm">Não</span>') ?></td>
                        <td class="text-right">
                          ...
                          <a title="Deletar" href="javascreipt(void)" data-toggle="modal" data-target="#servico-<?php echo $servico->servico_id; ?>"  class="btn btn-sm btn-danger"><i class="fas fa-user-times"></i></a>
                        </td>
                      </tr>
