                  ...
                  <tbody>
                    ...
                    <?php foreach ($categorias as $categoria): ?>
                      <tr>
                        ...
                        <td class="text-center pr-4"><?php echo ($categoria->categoria_ativa == 1 ? '<span class="badge badge-pill badge-info btn-sm">Sim</span>' : '<span class="badge badge-pill badge-warning btn-sm">Não</span>') ?></td>
                        <td class="text-right">
                          ...
                          <a title="Deletar" href="javascreipt(void)" data-toggle="modal" data-target="#categoria-<?php echo $categoria->categoria_id; ?>"  class="btn btn-sm btn-danger"><i class="fas fa-user-times"></i></a>
                        </td>
                      </tr>
