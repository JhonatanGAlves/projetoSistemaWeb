                ...
                <table class="table table-bordered dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo ($this->ion_auth->is_admin($user->id) ? 'Administrador' : 'Funcionário'); ?></td>
                      <td class="text-center pr-4"><?php echo ($user->active == 1 ? '<span class="badge badge-pill badge-info btn-sm">Sim</span>' : '<span class="badge badge-pill badge-warning btn-sm">Não</span>') ?></td>
                      <td class="text-right">
                        <a title="Editar" href="<?php echo base_url('usuarios/edit/'. $user->id); ?>" class="btn btn-sm btn-primary"><i class="fas fa-user-edit"></i></a>
                        <a title="Deletar" href="javascreipt(void)" data-toggle="modal" data-target="#user-<?php echo $user->id; ?>"  class="btn btn-sm btn-danger"><i class="fas fa-user-times"></i></a>
                      </td>
                    </tr>
